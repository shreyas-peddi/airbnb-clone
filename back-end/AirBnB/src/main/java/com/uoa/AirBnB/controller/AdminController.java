...
public class AdminController {
    ...
    public ResponseEntity<String> updateBooking(@PathVariable("id") Long id, @RequestBody @org.springframework.lang.Nullable BookingDto bookingDto) throws JsonProcessingException {
        if(bookingDto!=null)
